        ...
        <div className="space-y-4">
          {db.articles.map(article => (
            <div key={article.id} className="bg-[#1a1a1a] p-6 rounded-2xl flex items-center justify-between border border-white/5 hover:border-[#0C61BC]/30 transition-all shadow-lg">
              <div className="flex items-center gap-4"><img src={article.images[0]} className="w-16 h-16 rounded-xl object-cover" /><h4 className="font-bold uppercase tracking-tight text-white">{article.title}</h4></div>
